...
input1 = os.sep.join(['..', 'data_tgcn', dataset, 'build', dataset])
...
output1 = os.sep.join(['..', 'data_tgcn', dataset, 'build', dataset])
output2 = os.sep.join(['..', 'data_tgcn', dataset, 'build'])
...
# 根据语义依存构建边权重
data2 = pickle.load(open(input4 + "_semantic.pkl", "rb"))
max_count2 = 0.0
min_count2 = 0.0
count2 = []
for key in data2:
